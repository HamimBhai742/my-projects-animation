    ...
    <div className="mx-8 mt-5">
      ...
      <div>
        ...
        <ul className="list-disc list-inside ml-5 text-lg mt-2">
          ...
          <li>
            Choose <strong>Create Character</strong> and start designing your
            characters.
          </li>
          <li>
            ...
            <ul className="list-disc list-inside ml-5 text-lg">
              ...
              <li>Eye shape & color</li>
              <li>Clothes & accessories</li>
              <li>Other facial features like beard, glasses, or makeup</li>
            </ul>
          </li>
          <li>After finishing the customization, save the character.</li>
          <li>
      ...
      <div>
        ...
        <ul className="list-disc list-inside ml-5 text-lg mt-2">
          ...
          <li>
            Select the one that fits your story and place the characters in the
            scene.
          </li>
        </ul>
      ...
      <div>
        ...
        <ul className="list-disc list-inside ml-5 text-lg mt-2">
          ...
          <li>
            Adjust the volume levels so the music does not overpower the
            dialogue.
          </li>
        </ul>
      ...
      <div>
        ...
        <ul className="list-disc list-inside ml-5 text-lg mt-2">
          ...
          <li>Choose the video resolution (720p, 1080p).</li>
          <li>
            Click <strong>Save</strong>, and the animation will be processed.
          </li>
